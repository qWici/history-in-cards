...
function DropSlot({ index, active }: { index: number; active: boolean }) {
  ...
  return (
    <button
      ...
      onClick={() => place(index)}
      className={`mx-1.5 h-56 shrink-0 self-center rounded-lg border-2 border-dashed transition-all sm:mx-2 sm:h-60 ${
        isOver
      ...
      {status === "over" ? (
        ...
        >
          ...
          <main className="flex flex-1 flex-col items-center justify-center gap-3 pb-6">
            <div className="mb-1 flex -translate-y-[150px] flex-col items-center gap-1.5">
              {mode === "daily" ? (
            ...
            <section
              ...
              className="mt-[50px] w-full rounded-2xl bg-background-secondary/40"
            >
